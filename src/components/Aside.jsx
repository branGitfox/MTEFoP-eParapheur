...
<aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l ">
  <div className="w-full flex gap-2 items-center">
      <a href="#">
        <img class="w-[4rem] h-[4rem]" src="/mtefp_logo.jpeg" alt=""/>
        
    </a>
    <h1 className='font-normal  text-gray-900'>e-Parapheur</h1>
  </div>
  

    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-3 ">
            <Link class={`flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg ${ location.pathname ==='/scc'?'bg-blue-100':''} hover:bg-blue-100  hover:text-gray-700`} to="/scc">
                <GoTasklist size={20}/>

                <span class="mx-2 text-sm font-medium">Suivis</span>
            </Link>

            <Link class={`flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform  ${ location.pathname ==='/scc/register'?'bg-blue-100':''} rounded-lg hover:bg-blue-100  hover:text-gray-700`} to="/scc/register">
              <BiAddToQueue size={20}/>

                <span class="mx-2 text-sm font-medium">Enregistrement</span>
            </Link>    <Link class={`flex items-center px-3 py-2 text-gray-600 transition-colors duration-300  ${ location.pathname ==='/scc/stats'?'bg-blue-100':''} transform rounded-lg hover:bg-blue-100  hover:text-gray-700`} to='/scc/stats'>
                <FaChartLine/>

                <span class="mx-2 text-sm font-medium">Reporting</span>
            </Link>   
            {user.role=='admin'?
             <Link class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-blue-100  hover:text-gray-700" href="#">
