        ...
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2 -z-50">
          ...
          <div className="block lg:hidden pr-4">
            {showMenu === false ? (
              <button
                id="nav-toggle"
                onClick={toggleMenu}
                className="flex items-center p-1 text-[#B39F43] hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
              >
                <svg
          ...
          >
            ...
            <Link
              id="navAction"
              to={"/scc"}
              className="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-yellow-600 to-blue-900  text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            >
              Mon Dossier
            </Link>
          </div>
