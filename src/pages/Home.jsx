    ...
    <>
      ...
      <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <Link to={'/login'} className="mx-auto lg:mx-0 self-center hover:underline bg-white text-gray-800 font-bold rounded-full my-6 relative lg:top-10 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Se Connecter
          </Link>
        </div>
