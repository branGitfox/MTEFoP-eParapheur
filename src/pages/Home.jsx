      ...
      <div className="container px-3 mx-auto flex flex-wrap flex-col lg:flex-row items-center">
        ...
        <img src="/Rpp.png" alt="" className="w-[100px] h-auto" />
          ...
          <p className="leading-normal text-2xl  lg:m-auto  mb-8 text-left animate__animated animate__fadeInLeft">
            Application Web de suivi de Courriers dédié au Service Central de courriers au sein du Ministere afin de simplifier le  tracage de courriers.
        ...
        <div className="w-full md:w-3/5 py-6 text-right relative ">
          <img className="w-full animate__animated animate__fadeInRight md:w-4/5 z-50 relative lg:left-[7rem]" src="/hero.png" />
        </div>
      </div>
    </div>
