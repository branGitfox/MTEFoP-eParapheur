  ...
  return (
    <div className='relative'>
        <div className="w-[100%] h-screen bg-white relative overflow-y-scroll">
            ...
            <div className="lg:w-[50%] mx-auto h-12  relative top-[68px] mt-5 px-3 flex justify-evenly">
                <input type="text" className='px-2 py-3 w-full focus:outline-blue-900 rounded-l-3xl'/>
                <button className='bg-black'>Rechercher</button>
            </div>
        </div>
    </div>
  )
