...
<div class="flex items-center me-4">
  ...
  <option value='100'>100 lignes</option>
        ...
        <button disabled={page==moveByDirection?.last_page?true:false}  onClick={nextPage} class={`flex items-center px-4 py-2 mx-1  ${page<moveByDirection?.last_page?'bg-blue-600 text-white':'bg-gray-200 text-gray-700'} transition-colors duration-300 transform  rounded-md`}>
