  ...
  const [radio, setRadio] = useState("service")
    ...
    const submit =async (e) => {
        ...
        if(formData?.type == 'transfert'){
            ...
            data = {...formData, courrier_id:doc.c_id, user_id:user.id, status:"non reçu",current_trans_id:user.id_serv, current_trans_id_dir:0 ,description:doc.motif, transfere:"non", ref_initial:doc.chrono}

          
        }else{

           data = {...formData, courrier_id:doc.c_id, user_id:user.id, status:"non reçu", ...propr, current_trans_id:user.id_serv, current_trans_id_dir:0, description:doc.motif, transfere:"non", ref_initial:doc.chrono}
        }
